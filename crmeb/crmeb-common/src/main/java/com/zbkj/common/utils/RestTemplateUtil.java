...
//        restTemplate = new RestTemplate(requestFactory);
    ...
    public Object getDataForm(String url, MultiValueMap<String, Object> params, Map<String, String> header) {
        // 构建带参数的 URL
        ...
        // 发送 GET 请求
        HttpEntity<String> requestEntity = new HttpEntity<>(headers);
        String response = restTemplate.exchange(finalUrl, HttpMethod.GET, requestEntity, String.class).getBody();
        // 尝试解析为 JSONObject，若失败则返回原始字符串
        try {
