			...
			<div class="whiteBg" v-if="formItem === 1">
					...
					<form @submit.prevent="submit">
						<div class="item">
							<div class="acea-row row-middle">
								...
								<input type="number" class="texts" placeholder="输入账号（3到8位数字）" v-model="account" maxlength="8" required/>
							</div>
						</div>
						<div class="item">
							<div class="acea-row row-middle">
				...
				<div class="list" v-if="current !== 0 || appLoginStatus || appleLoginStatus">
					<div class="item">
						<div class="acea-row row-middle">
							<image :src="urlDomain+'crmebimage/perset/staticImg/phone_1.png'" style="width: 24rpx; height: 34rpx;"></image>
							<input type="number" class="texts" placeholder="输入账号" v-model="account" maxlength="8"/>
						</div>
					</div>
					<div class="item">
						<div class="acea-row row-middle">
				...
				<div class="logon bg_color" @click="submit" v-if="current === 0">登录 / 注册</div>
				<!-- #ifndef APP-PLUS -->
				<div class="tips">
		...
		export default {
			...
			methods: {
				...
				codeSend() {
					...
					if (!/^\d{3,8}$/i.test(that.account)) return that.$util.Tips({
						title: '请输入正确的账号（3到8位数字）'
					});
